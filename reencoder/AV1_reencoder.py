...
class AV1Reencoder(VideoReencoder):
    def reencode(self):
        """
        Realiza o reencoding de um video para o codec AV1 por meio da biblioteca libaom.
        ...
        Args:
            ...
            speed/preset (int): Velocidade que o ffmpeg fara a conversao. Aceita valores de 0 ~ 8, velocidade proporcional.
        ...
        """
        self._run_ffmpeg_command('libaom-av1')
    ...
    def _run_ffmpeg_command(self, codec):
        command = [
            ...
            '-c:v', codec,
            '-crf', str(self.crf),
            '-preset', str(self.speed),  # AV1 usa -preset ao inves de -speed
            '-threads', '2'
        ]
